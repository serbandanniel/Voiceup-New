...
const PrizesConfigPage: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            {/* Global Trophy Image Config - using Header to manage this section's save? Or just visually separate */}
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200">
                <AdminPageHeader 
                    title="Imagine Trofeu Central"
                    description="Personalizează imaginea principală a secțiunii de premii."
                    isEditing={true}
                    onEdit={() => {}}
            ...
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200">
                <AdminPageHeader 
                    title="Lista Premii"
                    description="Adaugă sau editează premiile individuale."
                    isEditing={true}
                    onEdit={() => {}}
                    onSave={() => {}}
                    onCancel={() => {}}
