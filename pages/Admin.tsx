...
const Icons = {
    ...
    Video: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>,
...
const MENU_STRUCTURE = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'floating', label: 'Butoane Plutitoare', icon: Icons.Design },
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-8 relative z-0">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="transition-all duration-300 min-h-[500px]">
                        ...
                        {activeTab === 'floating' && <FloatingButtonsConfigPage />}
