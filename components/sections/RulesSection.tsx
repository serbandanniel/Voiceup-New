...
const RulesSection: React.FC<{ section: SectionConfig }> = ({ section }) => {
    const steps = [
        {
            step: '1',
    ...
    return (
        <div className="max-w-screen-xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
                 <h3 className="text-3xl md:text-4xl font-extrabold text-brand-dark">Cum mă înscriu ?</h3>
                    ...
                    {steps.map((step) => (
                        <div key={step.step} className="relative z-10 flex flex-row items-start md:flex-col md:items-center text-left md:text-center">
                            ...
                            <div className="ml-6 md:ml-0 flex-grow md:flex md:flex-col md:bg-white/60 md:backdrop-blur-sm md:p-8 md:rounded-2xl md:shadow-lg md:border md:border-gray-100 w-full">
                                ...
                                <a href={step.linkHref} className="mt-auto font-bold text-brand-purple hover:underline text-sm flex items-center justify-start md:justify-center gap-2 group">
                                    {step.linkText}
